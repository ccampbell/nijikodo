...
class Php extends Generic
{
    ...
    protected function _preProcess()
    {
        ...
        $this->_addPattern('/(include(_once)?|require(_once)?)([(\s|\()])/', '<span class="' . $this->_css_prepend . '_keyword">$1</span>$4');
        $this->_addPattern('/new\s([^()\$]+)/', 'new <span class="' . $this->_css_prepend . '_function">$1</span>');
        $this->_addPattern('/extends\s([^\s]+)/', 'extends <span class="' . $this->_css_prepend . '_method"><em>$1</em></span>');
        $this->_addPattern('/([\:]{2})([A-Z_0-9]+)(;)/', '::<span class="' . $this->_css_prepend . '_int">$2</span>;');
        $this->_addPattern('/([a-zA-Z_0-9]+)([\:]{2})/', '<span class="' . $this->_css_prepend . '_class">$1</span><span class="' . $this->_css_prepend . '_keyword">::</span>');
